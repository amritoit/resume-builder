...
insert into workinfos (id, person_id, company_name, company_city, company_state, start_date, end_date, role, currently_working_here, created_at, updated_at)
...
insert into work_role_desc (id, person_id, workinfo_id, description, created_at, updated_at)
...
insert into workinfos (id, person_id, company_name, company_city, company_state, start_date, role, currently_working_here, created_at, updated_at)
